...
parser.add_argument('--dataset_name', dest='dataset_name', default='./datasets/4legs', help='name of the dataset')
parser.add_argument('--epoch', dest='epoch', type=int, default=600, help='# of epoch')
parser.add_argument('--batch_size', dest='batch_size', type=int, default=1, help='# images in batch')
parser.add_argument('--output_size', dest='output_size', type=int, default=256, help='then crop to this size')
parser.add_argument('--lr', dest='lr', type=float, default=1e-5, help='initial learning rate for optimizer')
...
def main(_):
    ...
    with tf.Session(config=config) as sess:
        model = normalnet(sess, image_size=args.output_size, batch_size=args.batch_size,
                        ...
                        dataset_name=args.dataset_name, coefficient=args.gradient_penalty_coefficient,phase=args.phase)
